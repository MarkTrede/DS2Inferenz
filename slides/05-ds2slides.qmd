...
in $x$ und $y$
\item Es gilt $F_{X,Y}(-\infty ,y) =F_{X,Y}(x,-\infty)=0$
...
$$
\begin{array}{c|ccc|}
X\backslash Y & y_1 & \ldots & y_K \\ \hline
x_1 & p_{11} & \ldots & p_{1K} \\ 
\vdots & \vdots &  & \vdots \\ 
x_J & p_{J1} & \ldots & p_{JK}
\end{array}
$$
\end{itemize}
...
Wie groß ist $F_{X,Y}(1.5,3.2)$ ?\uncover<2>{
...
&=\int_{a_2}^{b_2}\int_{a_1}^{b_1}f_{X,Y}(x,y)dxdy
\end{align*}
...
Zwei Würfel, $X$: kleinere Augenzahl, $Y$: größere Augenzahl
$$
\begin{array}{c|cccccc|c}
{\color<2>{red} X}\backslash {\color<3>{red} Y} & \color<3>{red}1 & \color<3>{red}2 & \color<3>{red}3 & \color<3>{red}4 & \color<3>{red}5 & \color<3>{red}6 & \color<2>{red}f_X\\ \hline
\color<2>{red} 1 & \frac{1}{36} & \frac{2}{36} & \frac{2}{36} & \frac{2}{36} & \frac{2}{36} & \frac{2}{36} & \color<2>{red}\frac{11}{36}\\
\color<2>{red} 2 & \color<4>{red}0            & \frac{1}{36} & \frac{2}{36} & \frac{2}{36} & \frac{2}{36} & \frac{2}{36} & \color<2,4>{red}\frac{9}{36}\\
\color<2>{red} 3 & 0            & 0            & \frac{1}{36} & \frac{2}{36} & \frac{2}{36} & \frac{2}{36} & \color<2>{red}\frac{7}{36}\\
\color<2>{red} 4 & 0            & 0            & 0            & \frac{1}{36} & \frac{2}{36} & \frac{2}{36} & \color<2>{red}\frac{5}{36}\\
\color<2>{red} 5 & 0            & 0            & 0            & 0            & \frac{1}{36} & \frac{2}{36} & \color<2>{red}\frac{3}{36}\\
\color<2>{red} 6 & 0            & 0            & 0            & 0            & 0            & \frac{1}{36} & \color<2>{red}\frac{1}{36}\\ \hline
\color<3>{red}f_Y &\color<3,4>{red}\frac{1}{36} & \color<3>{red}\frac{3}{36} & \color<3>{red}\frac{5}{36} & \color<3>{red}\frac{7}{36} & \color<3>{red}\frac{9}{36} & \color<3>{red}\frac{11}{36} &1\\
\end{array}
$$
\end{exampleblock}
...
# Zufallsvektoren
\framesubtitle{Bedingte Verteilung}
\textbf{Bedingte Verteilung}:\medskip
\begin{itemize}
\item Wie ist die Zufallsvariable $X$ verteilt, wenn über die Werte
der Zufallsvariablen $Y$ Angaben (oder Annahmen) vorliegen?
\item Erinnerung: Bedingte Wahrscheinlichkeit 
\[ P(A|B)=P(A\cap B)/P(B) \]
\item Bedingte Erwartungswerte: Wie hoch ist der Erwartungswert
von $X$, wenn $Y$ den Wert $y$ annimmt?
\end{itemize}
...
$$
E(X|Y=y_k)=\sum_{j=1}^J x_j P(X=x_j|Y=y_k)
$$
Zum Vergleich: (unbedingter) Erwartungswert
$$
...
# Zufallsvektoren
\framesubtitle{Bedingte Verteilung}
\begin{exampleblock}{Forts. Beispiel: Gemeinsam diskrete Verteilung}
Bedingte Verteilung von $Y$ (größere Augenzahl) gegeben $X=2$
$$
\begin{array}{c|c}
...
+4\cdot \frac{2}{9}
+5\cdot \frac{2}{9}
+6\cdot \frac{2}{9}=4.2222
$$
Der unbedingte Erwartungswert der größeren Augenzahl ist
$$
E(Y)=
1\cdot\frac{1}{36}
+2\cdot\frac{3}{36}
...
\right.
$$
Randdichte von $X$ ist 
$$
f_X(x)=x+1/2
$$
Bedingte Dichte von $Y$ gegeben $X=x$ für die $0\le y\le 1$
$$
f_{Y|X=x}(y)=\frac{x+y}{x+1/2}
$$
\end{exampleblock}
