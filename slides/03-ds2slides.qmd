...
\framesubtitle{Definition}
\begin{itemize}
\item Ihre erste Frage sollte immer lauten:
\medskip
\begin{center}
\textbf{Was ist die Zufallsvariable $X$?}
\bigskip
\end{center}
\end{itemize}
\begin{exampleblock}{Beispiele: Zufallsvariable}
\begin{itemize}
\item Beispiel 1: $X:$ Gewinn der Volkswagen AG 2024
\item Beispiel 2: $X:$ codiert Erwerbsstatus (0/1)
\item Beispiel 3: $X:$ Monatsgehalt zufällig ausgewählter Person
\end{itemize}
\end{exampleblock}
