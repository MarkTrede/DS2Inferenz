...
$$
P(A|B)=\frac{P(A\cap B)}{P(B)}=\frac{P(\{4,6\})}{P(\{4,5,6\})}=\frac{2}{3}
$$
  und die bedingte Wahrscheinlichkeit von $B$ gegeben $A$ lautet
$$
P(B|A)=\frac{P(B\cap A)}{P(A)}=\frac{P(\{4,6\})}{P(\{2,4,6\})}=\frac{2}{3}.
$$
...
- Zwei Würfel werden geworfen. Sei $A$ das Ereignis "die Augensumme ist 10". 
  ...
  Dann ist
$$
P(A|B)=\frac{P(A\cap B)}{P(B)}=\frac{P(\{\})}{P(\{21,22,23,24,25,26,12,32,42,52,62\})}=0.
$$
  Die bedingte Wahrscheinlichkeit für das Ereignis $C$: "Augensumme ist 5" 
  unter der Bedingung $B$ ist
$$
P(C|B)=\frac{P(C\cap B)}{P(B)}=\frac{P(\{23,32\})}{P(\{21,22,23,24,25,26,12,32,42,52,62\})}=\frac{2}{11}.
$$
...
- Bei einer Umfrage werden Personen zufällig ausgewählt und befragt. Sei $A$
  ...
  "die befragte Person arbeitet in Teilzeit". 
