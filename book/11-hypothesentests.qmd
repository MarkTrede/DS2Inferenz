...
Am Beginn des Strafverfahrens steht die Anklage. 
{{< var Dem >}} {{< var Angeklagten >}} wird ein Vergehen vorgeworfen. 
Ob die Anklage wahr oder falsch ist, d.h. ob {{< var der >}} Angeklagte die Tat wirklich begangen hat oder nicht, weiß {{< var die >}} {{< var Richterin >}} nicht. 
{{< var Die >}} {{< var Anwältin >}} {{< var des >}} Angeklagten behauptet, dass {{< var er >}} unschuldig ist. 
{{< var Der >}} {{< var Staatsanwalt >}} behauptet hingegen, dass {{< var der >}} Angeklagte schuldig ist. 
Damit {{< var die >}} {{< var Richterin >}} ein Urteil fällen kann, braucht {{< var sie >}} {{< var Zeugenaussagen >}} und Beweise. 

Im Allgemeinen hilft die Beweisaufnahme, ein genaueres Bild der möglichen Tat zu gewinnen. 
Auf Grundlage der Beweise fällt {{< var die >}} {{< var Richterin >}} {{< var ihr >}} Urteil. 
{{< var Sie >}} kann {{< var den >}} {{< var Angeklagten >}} verurteilen oder freisprechen. 
Natürlich wäre es wünschenswert, wenn {{< var der >}} Angeklagte verurteilt wird, sofern {{< var er >}} schuldig ist, und freigesprochen wird, sofern {{< var er >}} unschuldig ist. 
Aber selbst mit den Beweisen bleibt immer noch eine gewisse Restunsicherheit, ob {{< var der >}} Angeklagte die Tat wirklich begangen hat. 
Es kann also passieren, dass {{< var die >}} {{< var Richterin >}} {{< var den >}} {{< var Angeklagten >}} verurteilt, obwohl {{< var er >}} unschuldig ist. 
Es kann passieren, dass {{< var er >}} freigesprochen wird, obwohl {{< var er >}} schuldig ist. 
In beiden Fällen liegt ein Irrtum vor und es kommt zu einem Fehlurteil.

Welches Art von Fehlurteil ist schlimmer? Ist es schlimmer, wenn
{{< var ein >}} {{< var Schuldiger >}} freigesprochen wird? Oder ist es schlimmer,
wenn {{< var ein >}} {{< var Unschuldiger >}} verurteilt wird? Bei dieser Abwägung
...
pro reo - im Zweifel für {{< var den >}} {{< var Angeklagten >}}. 
Diese Asymmetrie 
...
Schuld nach einem Urteil. Wenn {{< var der >}} Angeklagte freigesprochen
wird, heißt das nur, dass die Beweise nicht für eine
Verurteilung ausreichen. Ein Freispruch ist keine wirklich
belastbare Aussage über die Unschuld {{< var des >}} Angeklagten. Man wäre
nicht sehr überrascht, wenn sich herausstellt, dass {{< var ein >}}
{{< var freigesprochener >}} {{< var Angeklagter >}} in Wirklichkeit schuldig ist.
Umgekehrt ist eine Verurteilung jedoch ein belastbares
Ergebnis. Man kann zwar nicht hundertprozentig, aber doch
ziemlich sicher sein, dass {{< var der >}} Angeklagte tatsächlich schuldig 
ist, wenn {{< var er >}} verurteilt wird. Die Beweislage wiegt so schwer,
...
Die Gegenstücke zu den Behauptungen von {{< var Rechtsanwältin >}} und 
{{< var Staatsanwalt >}} heißen **Nullhypothese** und **Alternativhypothese**
...
ist eine Beweislage, die deutlich für die Schuld {{< var des >}}
Angeklagten spricht. Deshalb verurteilt {{< var die >}} {{< var Richterin >}}
{{< var den >}} {{< var Angeklagten >}}. 
Wenn die Teststatistik nicht im kritischen Bereich 
liegt, wird die Nullhypothese nicht abgelehnt. {{< var Der >}}
Angeklagte wird mangels Beweisen nicht verurteilt.
...
obwohl sie wahr ist. {{< var Ein >}} {{< var Unschuldiger >}} wird verurteilt.
Ein **Fehler zweiter Art** (engl. error of the second kind) 
tritt auf, wenn die Nullhypothese
nicht abgelehnt wird, obwohl sie falsch ist. {{< var Ein >}}
{{< var Schuldiger >}} wird freigesprochen.
...
den {{< var Lesern >}} einer empirischen Untersuchung überlassen. Dann
kann {{< var jeder >}} selbst entscheiden, ob der Wert der Teststatistik
...
das man als {{< var Leser >}} gern hätte, lehnt man die 
