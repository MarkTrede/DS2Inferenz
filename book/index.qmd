...
um das Verhalten von ökonomischen {{< var Agenten >}} unter Unsicherheit geht. 
...
Für die wahrscheinlichkeitstheoretischen Grundlagen braucht man ein
wenig Grundkenntnisse über Mengen und Mengenoperationen. Sie 
werden im @sec-mengen knapp zusammengefasst. Hinweise auf weiterführende Literatur 
gibt @sec-literatur. Dieses eLehrbuch orientiert sich sowohl hinsichtlich 
seines Aufbaus als auch der Notation recht eng an dem auch im Anhang
aufgelisteten Lehrbuch von Mosler und Schmid (2011).
...
Der Text in diesem Lehrbuch ist nicht geschlechtsneutral formuliert. Sie
haben jedoch die Möglichkeit, eine gegenderte Version zu lesen.
Die Unterschiede sind außer in @sec-hypothesentests nicht sehr groß.
:::
