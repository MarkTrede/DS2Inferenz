...
\right.
$$
Der Plot der Dichte zeigt, dass die Zufallsvariable in dem Intervall
...
Für die Berechnung der Varianz ist manchmal diese Formel hilfreich:
$$
Var(X)=E(X^2)-(E(X))^2.
$$
