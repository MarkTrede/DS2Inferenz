...
Kennt man die Verteilungsfunktion, dann weiß man alles über die Verteilung, was 
wichtig ist.
...
```{r}
#| echo: FALSE
#| fig-cap: "Verteilungsfunktion einer diskreten Zufallsvariable"
par(cex=0.7)
x <- c(0, 3, 4, 9)
y <- c(0, 0.3, 0.4, 0.6, 1)
plot(stepfun(x, y),
...
```{r}
#| echo: FALSE
#| fig-cap: "Verteilungsfunktion der stetigen Zufallsvariable"
par(cex=0.7)
x <- c(-1, -0.56, 
       seq(-0.56, 1.1, length=100),
       1.1, 1.8)
