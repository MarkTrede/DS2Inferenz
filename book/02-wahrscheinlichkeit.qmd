...
(engl. probability measure) oder kurz Wahrscheinlichkeit (engl. probability), wenn gilt
...
::: callout-tip
<img src="images/AdobeStock_172088861b.jpeg" align="right" width=50%" style="padding-left:15px;padding-top:5px;padding-bottom:5px;"/>
...
::: callout-tip
<img src="images/AdobeStock_338942366b.jpeg" align="right" width=50%" style="padding-left:15px;padding-top:5px;"/>Es wird berichtet, dass 
...
::: callout-tip
<img src="images/AdobeStock_19427911b.jpeg" align="right" width=50%" style="padding-left:15px;padding-top:5px;"/>
...
Das Rind wird also vollständig in Teilmengen zerlegt, und alle Teilmengen
...
## Unabhängigkeit {#sec-unabhaengig}
...
## Wahrscheinlichkeitsbäume {#sec-baeume}
...
Die Vorgehensweise lässt sich am besten an einem konkreten
Beispiel erläutern. Als Beispiel betrachten wir den 
Erfolg einer Firma und den Einsatz ihres Managements. 
Dazu definieren wir die beiden Ereignisse 
$A$: "Die Firma hat Erfolg" und $B$:
"Das Management strengt sich an".

Gesucht sei die bedingte Wahrscheinlichkeit $P(B|A)=P(A\cap B)/P(A)$,
denn für die Auszahlung von Boni an Manager ist es wichtig zu wissen,
ob sie eine gute Leistung erbracht haben. Wenn das Management sich
nicht anstrengt, sollte keine Boni fließen.

Wir wollen bestimmen, wie hoch die Wahrscheinlichkeit ist, dass 
das Management sich tatsächlich angestrengt hat, wenn wir 
beobachten, dass die Firma erfolgreich ist. Oder anders gesagt: 
Ist der Erfolg der Firma wirklich ein Indikator
...
plot(c(0,1),c(0,1),t="n",xlab="",ylab="",axes=F,frame.plot = TRUE)
...
sollte in der Verträgen des Managements festgelegt sein.
