...
Der Parameter $\sigma^2$ hat einen Einfluss auf die Streuung der Zufallsvariable.
Wenn $\sigma^2$ klein ist (also nahe 0), dann ist die Dichte nah um den
Wert $\mu$ herum konzentriert. Je größer $\sigma^2$ ist, desto weniger ist
...
(z.B. Messfehler oder Produktionsabweichungen). 

Produktion von Schokoladentafeln
:::
