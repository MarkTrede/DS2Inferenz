...
Einen Bogenschützen kann man bitten, mehrfach auf die Zielscheibe
zu schießen, damit seine Zielgenauigkeit gemessen werden kann. Eine
...
Konfidenzintervalle. In vielen ökonomischen Studien werden
...
wählen will. Der Anteil der SPD-Wähler in der konkreten 
Stichprobe ist $\hat\pi=0.273$. Das konkrete 0.95-Konfidenzintervall 
für den Populationsanteil der SPD-Wähler ist
```{r}
n <- 1000
alpha <- 0.05
qnt <- qnorm(1 - alpha/2)
